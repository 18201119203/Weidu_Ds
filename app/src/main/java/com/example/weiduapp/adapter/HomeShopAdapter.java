...
public class HomeShopAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements HomehotItemAdapter.onClickitem,HomestyleItemAdapter.onClickitem,HomeliveItemAdapter.onClickitem{
    ...
    private HomeItemShopBean slist;
    ...
    public void setShopBean(HomeItemShopBean shopBean) {
        this.slist = shopBean;
...
*/
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        if (getItemViewType(position)==0){
            ...
            ((hotShopHolder)holder).title.setText(slist.result.rxxp.name);
            ((hotShopHolder)holder).rv.setLayoutManager(new GridLayoutManager(context,3));
            HomehotItemAdapter homehotItemAdapter = new HomehotItemAdapter(context, slist.result.rxxp.commodityList);
            ...
            ((hotShopHolder)holder).most_shop.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (clickitem!=null){
                        clickitem.getName(slist.result.rxxp.id);
                    }
                }
            });
            ...
            ((styleShopHolder)holder).title.setText(slist.result.mlss.name);
            ((styleShopHolder)holder).rv.setLayoutManager(new LinearLayoutManager(context));
            HomestyleItemAdapter homestyleItemAdapter = new HomestyleItemAdapter(context, slist.result.mlss.commodityList);
            ...
            ((styleShopHolder)holder).most_shop.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (clickitem!=null){
                        clickitem.getName(slist.result.mlss.id);
                    }
                }
            });
            ...
            ((liveShopHolder)holder).title.setText(slist.result.pzsh.name);
            ((liveShopHolder)holder).rv.setLayoutManager(new GridLayoutManager(context,2));
            HomeliveItemAdapter homeliveItemAdapter = new HomeliveItemAdapter(context,slist.result.pzsh.commodityList);
            ...
            ((liveShopHolder)holder).most_shop.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (clickitem!=null){
                        clickitem.getName(slist.result.pzsh.id);
                    }
                }
            });
        }
    ...
    public int getItemViewType(int position) {
        if (position==0){
            return 0;
        }else if (position==1&&1002==slist.result.rxxp.id){
            return 1;
        }else if (position==2&&1003==slist.result.mlss.id){
            return 2;
        }else{
            return 3;
        }
